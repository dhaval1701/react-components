...
var KTCardWidget8 = (function () {
  var e = { self: null, rendered: !1 },
    t = function (e) {
      ...
      if (t) {
        var a = parseInt(KTUtil.css(t, "height")),
          l = KTUtil.getCssVariableValue("--bs-gray-200"),
...
"undefined" != typeof module && (module.exports = KTCardWidget9),
  ...
  var KTCardWidget10a = (function () {
    var e = { self: null, rendered: !1 },
      t = function (e) {
        var t = document.getElementById("kt_card_widget_10a_chart");
        if (t) {
          var a = parseInt(KTUtil.css(t, "height")),
            l = KTUtil.getCssVariableValue("--bs-gray-100"),
            ...
            o = {
              ...
              colors: [KTUtil.getCssVariableValue("--bs-warning")],
              grid: {
                borderColor: l,
                strokeDashArray: 4,
                padding: { top: 0, right: -20, bottom: -20, left: -20 },
  ...
  "undefined" != typeof module && (module.exports = KTCardWidget10a),
    KTUtil.onDOMContentLoaded(function () {
      KTCardWidget10a.init();
    });


    var KTCardWidget11a = (function () {
        var e = { self: null, rendered: !1 },
          t = function (e) {
            var t = document.getElementById("kt_card_widget_11a_chart");
            if (t) {
              var a = parseInt(KTUtil.css(t, "height")),
                l = KTUtil.getCssVariableValue("--bs-gray-100"),
                r = KTUtil.getCssVariableValue("--bs-warning"),
      ...
      "undefined" != typeof module && (module.exports = KTCardWidget11a),
        KTUtil.onDOMContentLoaded(function () {
          KTCardWidget11a.init();
        });

        var KTCardWidget12a = (function () {
            var e = { self: null, rendered: !1 },
              t = function (e) {
                var t = document.getElementById("kt_card_widget_12a_chart");
                if (t) {
                  var a = parseInt(KTUtil.css(t, "height")),
                    l = KTUtil.getCssVariableValue("--bs-gray-100"),
                    r = KTUtil.getCssVariableValue("--bs-success"),
          ...
          "undefined" != typeof module && (module.exports = KTCardWidget12a),
            KTUtil.onDOMContentLoaded(function () {
              KTCardWidget12a.init();
            });

    var KTCardWidget13a = (function () {
        var e = { self: null, rendered: !1 },
            t = function (e) {
            var t = document.getElementById("kt_card_widget_13a_chart");
            if (t) {
                var a = parseInt(KTUtil.css(t, "height")),
                l = KTUtil.getCssVariableValue("--bs-gray-100"),
        ...
        "undefined" != typeof module && (module.exports = KTCardWidget13a),
        KTUtil.onDOMContentLoaded(function () {
            KTCardWidget13a.init();
        });

        var KTCardWidget14a = (function () {
            var e = { self: null, rendered: !1 },
                t = function (e) {
                var t = document.getElementById("kt_card_widget_14a_chart");
                if (t) {
                    var a = parseInt(KTUtil.css(t, "height")),
                    l = KTUtil.getCssVariableValue("--bs-gray-100"),
                    r = KTUtil.getCssVariableValue("--bs-danger"),
            ...
            "undefined" != typeof module && (module.exports = KTCardWidget14a),
            KTUtil.onDOMContentLoaded(function () {
                KTCardWidget14a.init();
            });


            var KTCardWidget15a = (function () {
                var e = { self: null, rendered: !1 },
                    t = function (e) {
                    var t = document.getElementById("kt_card_widget_15a_chart");
                    if (t) {
                        var a = parseInt(KTUtil.css(t, "height")),
                        l = KTUtil.getCssVariableValue("--bs-gray-100"),
                        r = KTUtil.getCssVariableValue("--bs-danger"),
